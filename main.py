...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        markov, length, delta_L_list = simulated_annealing(cooling_method=geom_cool, coord_list=coord_list, initial_time=1, \
            max_time=500, initial_temperature=200)
        with open("geom_cool.csv", "a") as f:
            writer=csv.writer(f, delimiter=';')
            writer.writerow([len(length)])
